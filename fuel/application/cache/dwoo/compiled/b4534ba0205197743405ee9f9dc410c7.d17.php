<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><div id="wrapper_section">
	...
	<div id="about_bg"><img src="images/about_bg.jpg"></div>
    ...
    <div id="cert_img">
    	...
    	<div class="cert_box"><img src="images/cert/cert1.jpg"></div>
        <div class="cert_box"><img src="images/cert/cert2.jpg"></div>
        <div class="cert_box"><img src="images/cert/cert3.jpg"></div>
        <div class="cert_box"><img src="images/cert/cert4.jpg"></div>  	
        ...
        <div id="fake_footer"></div><?php  /* end template body */
