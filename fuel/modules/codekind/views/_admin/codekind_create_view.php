				...
				<div class="panel-body">
					<div class="form-horizontal tasi-form">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codekind_name" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">分類描述</label>
							<div class="col-sm-4">
								<textarea class="form-control" name="codekind_desc" rows="3"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Codekind Key</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codekind_key" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Codekind Value1</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codekind_value1" value="">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">Codekind Value2</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codekind_value2" value="">
							</div>
						</div>
						<div class="form-group">
